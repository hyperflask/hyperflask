...
from flask_babel_plus import BabelPlus, _, _n, _lazy
...
map_jinja_call_node_to_func(_lazy)
...
class Hyperflask(Flask):
    ...
    def __init__(self, *args, static_mode="hybrid", instrument=False, layouts_folder="layouts", partials_folder="partials",
        ...
        self.assets.state.esbuild_aliases.update({
            ...
            "@hyperflask/hyperflask": os.path.abspath(os.path.join(os.path.dirname(__file__), "static", "lib.js"))
        })
        self.assets.bundle(
            {"@hyperflask": ["app.js"]},
            include=True,
