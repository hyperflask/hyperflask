<div><img src="assets/banner.svg" width="100%"></div>
<hr>
<div align="center">
...
Features and technologies:
 ...
 - Built on top of [Flask](https://flask.palletsprojects.com) as a set of extensions
 ...
 - Authentication and user management with social logins and MFA (via [Hyperflask-Auth](https://github.com/hyperflask/hyperflask-auth))
 - Static content collections to easily create blogs and manage static content
 - File management with built-in image manipulation and S3 integration (and more)
